...
namespace iSpyApplication.Vision
{
    ...
    /// most likely moving objects. And unlike <see cref="CustomFrameColorDifferenceDetector"/> motion
    ...
    /// to background changes, what <see cref="CustomFrameColorDifferenceDetector"/> algorithm can not do.
    ...
    ///     new SimpleColorBackgroundModelingDetector( ),
    ...
    public class SimpleColorBackgroundModelingDetector : IMotionDetector
    {
        ...
        private int _width;
        private int _height;
        private int _frameSize; // for background/input frame (can be color)
		private int _motionSize; // for motion frame (gray)

        // previous frame of video stream
        private UnmanagedImage _backgroundFrame;
        // current motion frame of video stream
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleColorBackgroundModelingDetector"/> class.
        /// </summary>
